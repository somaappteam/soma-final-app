...
class _GrammarModuleScreenState extends State<GrammarModuleScreen>
  ...
  Widget _buildSkillNode(GrammarSkillNode skill) {
    ...
    if (isCompleted) {
      ...
      nodeColor = AppColors.accentCoral;
    } else if (isLocked) {
      nodeColor = AppColors.neutralMid;
    } else {
        ...
        child: Column(
          children: [
            Container(
              ...
              height: 70,
              decoration: BoxDecoration(
                color: isLocked ? Theme.of(context).colorScheme.surfaceContainerHighest : Theme.of(context).cardTheme.color ?? Colors.white,
              ...
              child: Center(
                child: isLocked
                    ? Icon(Icons.lock, color: Theme.of(context).colorScheme.onSurface.withValues(alpha: 0.3), size: 28)
                    : isCompleted
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: isLocked ? Theme.of(context).colorScheme.surfaceContainer : nodeColor.withValues(alpha: 0.1),
              ...
              child: Text(
                ...
                style: TextStyle(
                  fontSize: 11,
                  fontWeight: FontWeight.w600,
                  color: isLocked ? Theme.of(context).colorScheme.onSurface.withValues(alpha: 0.4) : Theme.of(context).colorScheme.onSurface,
                ),
              ),
            ),
          ...
          Row(
            children: [
              Container(
                padding: const EdgeInsets.all(12),
                decoration: BoxDecoration(
                  color: (skill.color ?? AppColors.primaryTeal).withValues(alpha: 0.1),
                  borderRadius: BorderRadius.circular(16),
                ),
                child: Icon(
                  skill.icon ?? Icons.school,
